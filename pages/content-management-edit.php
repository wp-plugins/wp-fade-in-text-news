...
if (isset($_POST['FadeIn_form_submit']) && $_POST['FadeIn_form_submit'] == 'yes')
{
	...
	{	
		...
		$FadeIn_success = 'Details was successfully updated.';
	}
}
...
<div class="form-wrap">
	...
	<form name="FadeIn_form" method="post" action="#" onsubmit="return FadeIn_submit()"  >
      ...
      <textarea name="FadeIn_text" id="FadeIn_text" cols="130" rows="9"><?php echo esc_html(stripslashes($form['FadeIn_text'])); ?></textarea>
      <p>We can enter HTML content in this textarea.</p>
	  <label for="tag-link">Enter target link</label>
      <input name="FadeIn_link" type="text" id="FadeIn_link" value="<?php echo $form["FadeIn_link"]; ?>" size="125" maxlength="1024" />
